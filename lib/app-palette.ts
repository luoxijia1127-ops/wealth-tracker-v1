...
export const APP_PALETTE_THEMES: Record<AppPaletteId, AppPaletteTheme> = {
  ...
  /** Coolors「Monochrome Beach」炭灰 · 雾青 · 白 · 浅灰 · 深海蓝 */
  purple_rain_journal: {
    ...
    folderListBg: 'rgba(255, 255, 255, 0.92)',
    purposeAccent: '#3C6E71',
    chartLine: '#3C6E71',
    chartFillTop: 'rgba(60, 110, 113, 0.18)',
    chartFillBottom: 'rgba(217, 217, 217, 0.32)',
    goalRingColors: ['#284B63', '#3C6E71', '#353535', '#5C6D72'],
    tabBarBg: 'rgba(255, 255, 255, 0.96)',
    tabBarBorder: 'rgba(40, 75, 99, 0.1)',
    tabActive: '#284B63',
    tabInactive: 'rgba(40, 75, 99, 0.38)',
    chartGridStroke: 'rgba(40, 75, 99, 0.08)',
    dashboardStageBg: '#284B63',
    surfaceWhite: '#FFFFFF',
    statusPositive: '#2F6F64',
    statusNegative: '#A63D3D',
