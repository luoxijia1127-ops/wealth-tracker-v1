...
export const APP_PALETTE_THEMES: Record<AppPaletteId, AppPaletteTheme> = {
  ...
  sea: {
    ...
    chartLine: '#7678ED',
    chartFillTop: 'rgba(118, 120, 237, 0.22)',
    chartFillBottom: 'rgba(255, 255, 255, 0.04)',
  ...
  cotton_candy_romance: {
    ...
    chartLine: '#0A9396',
    chartFillTop: 'rgba(10, 147, 150, 0.2)',
  ...
  monochrome_beach: {
    ...
    chartLine: '#06D6A0',
    chartFillTop: 'rgba(6, 214, 160, 0.22)',
    chartFillBottom: 'rgba(255, 255, 255, 0.05)',
  ...
  /** Coolors 六色套：赭石 / 薄荷 / 灰 / 奶油 / 黑 / 森绿 */
  mountain_twilight: {
    id: 'mountain_twilight',
    nameZh: '林间奶油',
    swatches: ['#B88D49', '#B0D7D0', '#C6C6C6', '#1A3023', '#000000'],
    pageBg: '#FDFDD5',
    primary: '#1A3023',
    categoryAccents: {
      Stock: '#B88D49',
    ...
    folderListBg: 'rgba(255, 255, 253, 0.92)',
    purposeAccent: '#B88D49',
    chartLine: '#B0D7D0',
    chartFillTop: 'rgba(176, 215, 208, 0.28)',
    chartFillBottom: 'rgba(255, 255, 255, 0.06)',
    goalRingColors: ['#B88D49', '#B0D7D0', '#C6C6C6', '#1A3023'],
    tabBarBg: 'rgba(255, 255, 253, 0.96)',
    tabBarBorder: 'rgba(26, 48, 35, 0.1)',
    tabActive: '#1A3023',
    tabInactive: 'rgba(26, 48, 35, 0.38)',
    chartGridStroke: 'rgba(26, 48, 35, 0.09)',
    dashboardStageBg: '#1A3023',
    surfaceWhite: '#FFFEF6',
    statusPositive: '#2D6A4F',
    statusNegative: '#9B2226',
    headerActionBg: '#1A3023',
